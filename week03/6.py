...
import pymysql
from sqlalchemy import create_engine, Table, Float, Column, Integer, String, MetaData, ForeignKey,collate
...
class userinfo(Base):
    ...
    name = Column(String(15), nullable=True,nullable=False, unique=True, COMMENT='用户信息表')
